...
namespace OGFoodAPI_testing
{
    public class Tests
    {
        ...
        public async Task LocalStorage_Test_Korvstroganoff(int a, int b, int c)
        {
            ...
            const string expected = "[{\"Name\":\"Korvstroganoff\",\"Description\":\"Klassisk javla korvstroganoff\",\"IngredientsWithAmount\":[{\"Ingredient\":{\"Id\":\"1\",\"Name\":\"Lok\"},\"Amount\":1.0,\"Unit\":\"\"},{\"Ingredient\":{\"Id\":\"2\",\"Name\":\"Falukorv\"},\"Amount\":0.5,\"Unit\":\"\"},{\"Ingredient\":{\"Id\":\"3\",\"Name\":\"Tomatpuré\"},\"Amount\":2.0,\"Unit\":\"\"}]}]";
